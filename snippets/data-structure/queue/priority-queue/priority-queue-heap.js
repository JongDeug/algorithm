...
export class PriorityQueueHeap {
    ...
    bubbleUp() {
        ...
        while (true) {
            ...
            if (!(currentIndex < this.values.length && currentIndex >= 0) || !(parentIndex < this.values.length && parentIndex >= 0)) break;
    ...
    bubbleDown() {
        ...
        while (true) {
            ...
            if (rightChildIndex < this.values.length) {
                ...
                if ((swapIndex === null && currentElement > rightChildElement) || (swapIndex !== null && rightChildElement < leftChildElement)) {
